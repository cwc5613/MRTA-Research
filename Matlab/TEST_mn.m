...
for iii = 1:length(m)
    ...
    [theta,init_x,init_task] = INIT(n(iii),m(iii));
    ...
    [t,XY] = ode45(@(t,x) odefcn(t,x,n(iii),m(iii),range,theta,alpha,beta),tspan,init_x);
    ...
    m_vec = [m_vec;m(iii)];
    n_vec = [n_vec;n(iii)];
    DATA = [alpha_beta,task_count_vec,het_vec,dist_vec,m_vec,n_vec];
